...
## Summary
- 2221 nodes · 4362 edges · 141 communities (131 shown, 10 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 187 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d689862e`
...
1. `SwiftUI` - 76 edges
2. `CommunityAPI` - 71 edges
3. `AuthStore` - 40 edges
4. `Foundation` - 38 edges
5. `Color` - 38 edges
6. `UpcomingEvent` - 37 edges
7. `ActivitiesView` - 33 edges
8. `MapModel` - 33 edges
9. `SJMapView` - 32 edges
10. `TimelineEvent` - 29 edges
...
Cohesion: 0.20
Nodes (11): ClassifiedEvent, CommunityFeedBucket, fresh, later, thisWeek, CommunityFeedBucketer, Bool, Calendar (+3 more)

### Community 2 - ".event"
Cohesion: 0.15
Nodes (21): CarouselDots, EventShelfCard, ExploreCategoryTile, ExploreComposeBanner, exploreEventDateline(), ExplorePlaceCard, ExploreSectionHeader, ExploreTownHeader (+13 more)
...
Cohesion: 0.06
Nodes (44): Almanac, AlmanacReveal, AlmanacSection, Nudge, AttributedString, Bool, CGFloat, Date (+36 more)

### Community 5 - "CommunityFeedBucketer"
Cohesion: 0.67
Nodes (4): Place, PlaceFact, Places, String

### Community 6 - "ClassifiedEvent"
Cohesion: 0.07
Nodes (27): Change, Kind, delete, insert, update, RealtimeClient, Row, Status (+19 more)
...
Cohesion: 0.14
Nodes (32): Hashable, PendingPost, AgendaEvent, AgendaRow, ClubInput, ClubRef, ClubRow, ClubStatus (+24 more)

### Community 9 - ".decode"
Cohesion: 0.11
Nodes (9): HTTPURLResponse, CommunityAPI, Any, Bool, Data, Int, String, T (+1 more)

### Community 10 - "BoardRow"
Cohesion: 0.15
Nodes (10): BoardFullRow, BoardRow, BoardSections, IdRow, URL, BoardModel, BoardView, Bool (+2 more)

### Community 11 - "String"
Cohesion: 0.10
Nodes (16): ActivitiesModel, Set, String, HomeModel, Bool, Set, String, HomeView (+8 more)

### Community 12 - "Trail"
Cohesion: 0.25
Nodes (18): ClubExploreCard, EventExploreCard, EventGroup, EventInviteCircle, eventTimeKey(), fullWeekday(), groupRecurring(), mapsURL() (+10 more)
...
Cohesion: 0.13
Nodes (10): ActivitiesView, Bool, Place, Set, Suggestion, TimeFrame, month, today (+2 more)

### Community 16 - "ClubStatus"
Cohesion: 0.06
Nodes (29): App, CoreText, ExploreSearchOverlay, Animation, Bool, Double, String, Suggestion (+21 more)
...
Cohesion: 0.13
Nodes (12): Alignment, ComposeSpeedDial, SpeedDialAnchor, bottomTrailing, topTrailing, SpeedDialItem, Bool, CGFloat (+4 more)
...
Cohesion: 0.13
Nodes (19): DayDetailView, DaySlot, EventDescriptionSheet, Kind, event, open, Bool, Date (+11 more)
...
Cohesion: 0.09
Nodes (22): DragGesture, MapSheet, PlaceRow, SheetDetent, full, medium, peek, SheetMode (+14 more)

### Community 23 - "CalendarView"
Cohesion: 0.12
Nodes (18): CaseIterable, CalendarModel, Calendar, Int, Set, String, AgendaRowCard, CalendarFace (+10 more)
...
Cohesion: 0.07
Nodes (26): AnyView, AppInviteCard, ShareCenter, SharePayload, Any, Bool, String, UIImage (+18 more)

### Community 26 - "MainTabsView"
Cohesion: 0.18
Nodes (9): HyggeTabBar, RootView, CGFloat, String, Tab, activities, calendar, home (+1 more)

### Community 27 - "SpotFilter"
Cohesion: 0.33
Nodes (6): HaloText, MapPinBadge, POISelectedMarker, PulseRing, CGFloat, String
...
### Community 32 - "Spot"
Cohesion: 0.17
Nodes (10): MapSpots, Spot, Bool, CLLocationCoordinate2D, Hasher, String, QuickAddSheet, Binding (+2 more)
...
Cohesion: 0.18
Nodes (14): UpcomingEvent, CommunityFeedSection, CommunityFeedEmptyState, CommunityFeedEndState, CommunityFeedEventCard, CommunityFeedLoadingState, CommunityFeedPostedImage, CommunityFeedSectionView (+6 more)
...
Cohesion: 0.18
Nodes (6): SJMapView, Bool, Double, MapboxMap, Set, Void
...
Cohesion: 0.13
Nodes (11): ButtonStyle, CoralPillStyle, PeekLineStyle, Configuration, InterestCard, PressableCardStyle, Bool, Configuration (+3 more)
...
### Community 53 - "Pop"
Cohesion: 0.19
Nodes (10): AppearStagger, Pop, PopIn, CGFloat, Configuration, Content, Double, Int (+2 more)

### Community 54 - "InlineAction"
Cohesion: 0.20
Nodes (10): AddKind, club, event, trail, AddView, Kind, String, SpeedDialAction (+2 more)
...
Cohesion: 0.15
Nodes (10): DateComponents, Admin, DateHelpers, firstNameFromEmail(), Bool, Date, Int, String (+2 more)
...
Cohesion: 0.31
Nodes (4): MainTabsView, Bool, Place, Void

### Community 69 - "Interests"
Cohesion: 0.44
Nodes (5): CommunityFeedPreview, FixtureEvent, Date, Int, String

### Community 70 - "TrailsMapView"
Cohesion: 0.16
Nodes (16): openInGoogleMaps(), CGFloat, CGRect, CLLocationCoordinate2D, String, URL, Void, TrailMapPin (+8 more)
...
Cohesion: 0.06
Nodes (27): SplashView, categoryChip(), labeledField(), Binding, Bool, String, View, View (+19 more)
...
### Community 79 - ".line"
Cohesion: 0.27
Nodes (6): DailyGreeting, DayPart, afternoon, evening, morning, Date
...
Cohesion: 0.25
Nodes (5): ProfileAPI, Bool, Data, String, T

### Community 82 - "InsightsData"
Cohesion: 0.25
Nodes (7): Filter, all, clubs, events, parks, saved, trails
...
Cohesion: 0.24
Nodes (5): ProfileModel, Bool, Int, String, UIImage
...
Cohesion: 0.28
Nodes (6): SafariView, Context, URL, SafariServices, SFSafariViewController, UIViewControllerRepresentable
...
### Community 118 - "QuickAddSheet"
Cohesion: 0.33
Nodes (3): CommunityFeedBucketerSelfCheck, String, ISO8601DateFormatter
...
### Community 125 - "ViewModifier"
Cohesion: 0.33
Nodes (5): BlurFade, CGFloat, Content, Double, ViewModifier
...
### Community 129 - "BundleImage.swift"
Cohesion: 0.33
Nodes (5): SpotFilter, all, campus, downtown, outdoors
...
- **Why does `SwiftUI` connect `SwiftUI` to `OnboardingChrome.swift`, `.event`, `.sections`, `CommunityFeedBucketer.swift`, `.isFresh`, `BoardRow`, `Trail`, `.monthDateRows`, `ClubStatus`, `SpeedDialItem`, `POI`, `DayDetailView`, `BentoStatGrid`, `MapSheet`, `CalendarView`, `ProfileView`, `ShareCenter`, `MainTabsView`, `SpotFilter`, `Spot`, `EventCategory`, `ShareTargets.swift`, `ExploreKit.swift`, `OnboardingView`, `ButtonStyle`, `Image`, `TodayInStJoeContent`, `MapIntroView.swift`, `InlineAction`, `CoreLocation`, `TownMenuAction`, `View`, `TrailsMapView`, `SpringReveal`, `TrailsListView.swift`, `EntriesStatCard`, `AroundTownCarousel`, `PlaceFamily`, `VenueAutocompleteField`, `ProfileModel`, `StaggeredAppear`, `SafariView`, `ModerationView`, `GlassShowcaseOverlay`, `Masthead`, `PlaceDetailView`, `InsightsMiniCalendar`, `HyggeLogoBadge.swift`, `InterestPickerView`, `StreakHeroCard`, `ContinueButton`?**
  _High betweenness centrality (0.089) - this node is a cross-community bridge._
- **Why does `CommunityAPI` connect `.decode` to `Spot`, `ClassifiedEvent`, `.minutesOf`, `BoardRow`, `String`, `.rsvpEvent`, `ProfileModel`, `CalendarView`, `ModerationView`?**
  _High betweenness centrality (0.050) - this node is a cross-community bridge._
- **Why does `AuthStore` connect `AuthStore` to `CommunityFeedBucketer.swift`, `ClassifiedEvent`, `.decode`, `BoardRow`, `String`, `Codable`, `.monthDateRows`, `.rsvpEvent`, `CalendarView`, `MainTabsView`, `.validAccessToken`, `Spot`, `Session`, `SJMapView`, `Foundation`, `ProfileAPI`, `ProfileModel`, `.run`, `ModerationView`, `onThisDay`?**
