...
//  Hygge — the full-screen "warming up" cover shown while a tab's content is
...
struct TabLoadingCover: View {
    ...
    var wordmark: String? = "Hygge"
    /// Lower-third lines: the honest "what's loading" line first, then a few real
    /// things worth knowing about Hygge / St. Joe. They cross-fade while the cover
