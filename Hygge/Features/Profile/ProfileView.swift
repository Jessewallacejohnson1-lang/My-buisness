//
//  ProfileView.swift
//  Hygge — the community profile. A warm frosted-glass sheet: the town knows your
    ...
    private var settingsGroup: some View {
        VStack(alignment: .leading, spacing: 10) {
            ...
            GlassGroup {
                ...
                ProfileRowDivider()
                ProfileRow(icon: "info.circle", title: "About Hygge",
...
struct AboutHyggeSheet: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 16) {
            HStack {
                Text("About Hygge").font(.display(26)).foregroundStyle(Hue.ink)
                Spacer()
