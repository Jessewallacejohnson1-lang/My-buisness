...
- **Merge note for `chore/instruction-system`.** That branch moves this prose into
  `docs/rules/architecture.md`, `docs/rules/design.md`, `DESIGN.md` and `DECISIONS.md`.
  Whichever of the two branches merges second must carry these edits into those files.
