-- ============================================================================
-- Fixed-shape Today briefing read model for authenticated clients.
-- Resolves the requested town-local date, aggregates social state, and returns
-- a complete empty payload when no published briefing exists for that date.
-- ============================================================================
