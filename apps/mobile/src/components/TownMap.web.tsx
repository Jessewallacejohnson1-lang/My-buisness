  ...
  return (
    <View style={{ flex: 1, backgroundColor: C.canvas, alignItems: 'center', justifyContent: 'center', padding: 32 }}>
      <View style={{ alignItems: 'center', gap: 12, maxWidth: 360 }}>
        ...
        <Text style={{ fontFamily: F.mono, fontSize: 10.5, color: C.ink3, letterSpacing: 1.6 }}>THE TOWN MAP</Text>
        <Text style={{ fontFamily: F.display, fontSize: 22, color: C.ink, letterSpacing: -0.3, textAlign: 'center' }}>
          The map lives in the app
        </Text>
        <Text style={{ fontFamily: F.sans, fontSize: 14, color: C.ink2, lineHeight: 21, textAlign: 'center' }}>
        ...
        >
          <Text style={{ fontFamily: F.sansSemi, fontSize: 13.5, color: C.ink }}>Open the calendar</Text>
        </Pressable>
      </View>
    </View>
  )
